...
ind_brick=gf_model_set(md,'add basic contact brick', \tstr varname_u, \tstr multname_n, \tstr dataname_r, \tmat BN[, \tstr dataname_gap[, \tstr dataname_alpha]])
@@
\end{synopsis}
\begin{cmddescription}
...
\sep{@@ind_brick=gf_model_set(md,'add basic contact brick', \tstr varname_u, \tstr multname_n, \tstr dataname_r, \tmat BN[, \tstr dataname_gap[, \tstr dataname_alpha]])@@} :
