...
gf\_compute(mf, U, 'convect', \tmf mf_v, \tvec V, \tscal dt, \tint nt) 
@@\end{synopsis}
\begin{cmddescription}
...
\end{cmdexamples}
  ...
  \sep{@@gf\_compute(mf, U, 'convect', \tmf mf_v, \tvec V, \tscal dt, \tint nt)@@} Compute a convection of `U` with regards to a steady state velocity
