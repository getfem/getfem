...
\sep{@@gf_model_set(md,'add Dirichlet condition with penalization', \tmim mim, \tstr varname, \tint region, \tscalar coeff[, \tstr dataname ])@@} :
Add a Dirichlet condition on the variable @@varname@@ and the mesh
region @@region@@. This region should be a boundary. The Dirichlet
...
\sep{@@gf_model_set(md,'change penalization coeff Dirichlet', \tint ind_brick, \tscalar coeff)@@} :
