...
\newcommand{\tgl}{\vartype{global\_function}\xspace}
\newcommand{\tls}{\vartype{level\_set}\xspace}
...
V = gf_model_get(md, 'compute Von Mises or Tresca', \tstr varname, \tstr lawname, \tstr dataname, \tmf mf_vm[, \tstr version])
M = gf_model_get(md,'matrix term', \tint ind_brick, \tint ind_term)
I = gf_model_get(md,'interval of variable', \tstr varname)
@@
\end{synopsis}
\begin{cmddescription}
...
\sep{@@V = gf_model_get(md, 'compute Von Mises or Tresca', \tstr varname, \tstr lawname, \tstr dataname, \tmf mf_vm[, \tstr version])@@} :
...
\sep{@@M = gf_model_get(md,'matrix term', \tint ind_brick, \tint ind_term)@@} :
Gives the matrix term ind_term of the brick ind_brick if it exists

sep{@@I = gf_model_get(md,'interval of variable', \tstr varname)@@} :
...
gf_model_set(md,'resize variable' \tstr name, \tint size)
...
ind = gf_model_set(md, 'add nonlinear elasticity brick',\@tmim mim, \tstr varname, \tstr constitutive_law, \tstr dataname[, \tint region])
ind = gf_model_set(md, 'add linear incompressibility brick', \tmim mim, \tstr varname, \tstr multname_pressure[, \tint region])
...
ind_brick=gf_model_set(md,'add basic contact brick', \tstr varname_u, \tstr multname_n[, \tstr multname_t], \tstr dataname_r, \tmat BN[, \tmat BT, \tstr dataname_friction_coeff][, \tstr dataname_gap[, \tstr dataname_alpha[, \tint symmetrized]]])
gf_model_set(md,'contact brick set BN', \tint indbrick, \tmat BN)
gf_model_set(md,'contact brick set BT', \tint indbrick, \tmat BT)
ind_brick=gf_model_set(md, 'add contact with rigid obstacle brick', \tmim mim, \tstr varname_u, \tstr multname_n[, \tstr multname_t], \tstr dataname_r[, \tstr dataname_friction_coeff], \tint region, \tstr obstacle, [,  \tint symmetrized])
@@
\end{synopsis}
\begin{cmddescription}
...
\sep{@@gf_model_set(md,'resize variable', \tstr name, \tint size)@@} :
Resize a fixed size variable of the model. @@name@@ is the variable name, @@size@@ is the new fixed size.
...
\sep{@@ind = gf_model_set(md, 'add nonlinear elasticity brick',\@tmim mim, \tstr varname, \tstr constitutive_law, \tstr dataname[, \tint region])@@} :
...
\sep{@@ind = gf_model_set(md, 'add linear incompressibility brick', \tmim mim, \tstr varname, \tstr multname_pressure[, \tint region])@@} :
...
\sep{@@ind_brick=gf_model_set(md,'add basic contact brick', \tstr varname_u, \tstr multname_n[, \tstr multname_t], \tstr dataname_r, \tmat BN[, \tmat BT, \tstr dataname_friction_coeff][, \tstr dataname_gap[, \tstr dataname_alpha[, \tint symmetrized]]])@@} :
...
\sep{@@ind_brick=gf_model_set(md, 'add contact with rigid obstacle brick', \tmim mim, \tstr varname_u, \tstr multname_n[, \tstr multname_t], \tstr dataname_r[, \tstr dataname_friction_coeff], \tint region, \tstr obstacle, [,  \tint symmetrized])@@} :
