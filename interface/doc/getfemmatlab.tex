...
\end{purpose}
\begin{synopsis}
@@\tint gf_model_get(md,'is_complex')
...
\tscal gf_model_get(md,'memsize')
gf_model_get(md,'solve' [,...])@@
\end{synopsis}
\begin{cmddescription}
\sep{@@\tint gf_model_get(md,'is_complex')@@} :
...
\sep{@@\tscal gf_model_get(md,'memsize')@@} :
return the amount of memory (in bytes) used by the model state.
...
gf_model_set(md,'add mult on region', \tstr name, \tmf mf, \tmim mim, \tstr primalname, \tint region[, \tint niter])
...
ind_brick=gf_model_set(md,'add Dirichlet condition with penalization', \tmim mim, \tstr varname, \tint region, \tscal coeff[, \tstr dataname ])
gf_model_set(md,'change penalization coeff Dirichlet', \tint ind_brick, \tscal coeff)@@
\end{synopsis}
\begin{cmddescription}
...
\sep{@@ind_brick=gf_model_set(md,'add Dirichlet condition with penalization', \tmim mim, \tstr varname, \tint region, \tscal coeff[, \tstr dataname ])@@} :
Add a Dirichlet condition on the variable @@varname@@ and the mesh
region @@region@@. This region should be a boundary. The Dirichlet
