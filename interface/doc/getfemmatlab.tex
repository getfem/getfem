...
gf_model_set(md,'add initialized fem data')
gf_model_set(md,'add data')
gf_model_set(md,'add initialized data')
gf_model_set(md,'add mult on region')
gf_model_set(md,'add Laplacian brick')
gf_model_set(md,'add generic elliptic brick')
gf_model_set(md,'add source term brick')
gf_model_set(md,'add Dirichlet condition with multiplier')@@
\end{synopsis}
\begin{cmddescription}
...
\sep{@@gf_model_set(md,'add mult on region', \tstr name, \tmf mf, \tmim mim, \tstr primalname, \tint region[, \tint niter])@@} :
...
\sep{@@gf_model_set(md,'add Laplacian brick', \tmim mim, \tstr varname[, \tint region])@@} :
...
\sep{@@gf_model_set(md,'add generic elliptic  brick', \tmim mim, \tstr varname, \tstr dataname[, \tint region])@@} :
...
\sep{@@gf_model_set(md,'add source term  brick', \tmim mim, \tstr varname, \tstr dataname[, \tint region[, \tstr directdataname ]])@@} :
...
\sep{@@gf_model_set(md,'add Dirichlet condition with multiplier', \tmim mim, \tstr varname, \tstr multname | \tmf mf_mult | \tint degree, \tint region[, \tstr dataname ])@@} :
...
\sep{@@gf_model_set(md,'add Dirichlet condition with penalization', \tmim mim, \tstr varname, \tint region, \tscal coeff[, \tstr dataname ])@@} :
Add a Dirichlet condition on the variable @@varname@@ and the mesh
region @@region@@. This region should be a boundary. The Dirichlet
...
\sep{@@gf_model_set(md,'change penalization coeff Dirichlet', \tint ind_brick, \tscal coeff)@@} :
