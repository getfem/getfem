...
if using_HHO:
    # Elasticity term
    md.add_linear_term(mim, "clambda*Trace(HHO_Grad_u)*Trace(HHO_Grad_Test_u)" + "+ 2*cmu*Sym(HHO_Grad_u):Sym(HHO_Grad_Test_u)")
    # Stabilization term
...
if Dirichlet_with_multipliers:
    ...
    md.add_Dirichlet_condition_with_penalization(mim, "u", dirichlet_coefficient, GAMMAD, "Ue")
