...
if using_HHO:
    ...
    md.add_macro("HHO_Stab_Test_u", "Elementary_transformation(Test_u, HHO_Stab)")
...
if Dirichlet_with_multipliers:
    md.add_Dirichlet_condition_with_multipliers(mim, "u", mfu, DIRICHLET_BOUNDARY_NUM1, "Ue")
else:
    md.add_Dirichlet_condition_with_penalization(mim, "u", dirichlet_coefficient, DIRICHLET_BOUNDARY_NUM1, "Ue")

# Dirichlet condition on the top.
# Two Dirichlet brick in order to test the multiplier
# selection in the intersection.
if Dirichlet_with_multipliers:
    md.add_Dirichlet_condition_with_multipliers(mim, "u", mfu, DIRICHLET_BOUNDARY_NUM2, "Ue")
else:
    md.add_Dirichlet_condition_with_penalization(mim, "u", dirichlet_coefficient, DIRICHLET_BOUNDARY_NUM2, "Ue")
