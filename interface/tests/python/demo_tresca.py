...
m = gf.Mesh("regular_simplices", np.arange(0, 2 + 1.0 / NX, 1.0 / NX), np.arange(0, 1 + 1.0 / NX, 1.0 / NX))
...
md.add_nonlinear_term(mim, "(1/gh)*P(dnu-gh*u,thr)*(theta*dnv-gh*Test_u)", CONTACT_BOUNDARY)
