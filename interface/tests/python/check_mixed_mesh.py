...
ETA1tmp = gf.asm_generic(mim, 1, bulkresidual, -1, md, "psi", True, mfer, np.zeros(mfer.nbdof()))
...
ETA2tmp = gf.asm_generic(mim, 1, edgeresidual, INNER_FACES, md, "psi", True, mfer, np.zeros(mfer.nbdof()))
...
ETA3tmp = gf.asm_generic(mim, 1, edgeresidual_Neumann, NEUMANN_BOUNDARY, md, "psi", True, mfer, np.zeros(mfer.nbdof()))
...
ETA4tmp = gf.asm_generic(mim, 1, edgeresidual_Neumann, NEUMANN_BOUNDARY_NO_LOAD, md, "psi", True, mfer, np.zeros(mfer.nbdof()))
