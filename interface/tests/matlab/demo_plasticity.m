...
if (new_test == 1)
  f = [10000 0]';
  t = [0 0.0001 0.1 0.9032 1 1.1 1.3 1.5 1.7 1.74 1.7 1.5 1.3 1.1 1 0.9032 0.7 0.5 0.3 0.1 0];
end
...
for step=1:nbstep,
    ...
    if (new_test)
      ...
      coeff2='1/(2*mu)';
      Ainv=sprintf('(%s)*Reshape(Id(meshdim*meshdim),meshdim,meshdim,meshdim,meshdim) + (%s)*(Id(meshdim)@Id(meshdim))', coeff2, coeff1);
