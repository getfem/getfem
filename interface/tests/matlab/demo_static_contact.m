...
version = 7; % 1 : frictionless contact and the basic contact brick
...
elseif (version >= 5 && version <= 7) % The continuous version, Newton
...
elseif (version == 8) % The continuous version, Uzawa
