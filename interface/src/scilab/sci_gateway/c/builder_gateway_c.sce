...
cflags = '-g -I' + getfem_path + ' -I' + getfem_path + '../../../' + ' -I' + getfem_path + '../../src/c' + ' -D_SCILAB_';
ldflags = getfem_path + '/../../../.libs/libgetfemint.a ' + getfem_path + '/../../../../../src/.libs/libgetfem.a -L/usr/lib -lqhull -lmuparser';
