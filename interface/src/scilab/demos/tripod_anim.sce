...
//gf_plot_mesh(m,'cvlst',gf_mesh_get(m,'outer faces'),'curved','on','edges_color',[1 0 0]); hold on;
pr   = 1;
haut = 0;
for r=[6 14 26]
  disp('slicing...'); tic;
  ...
  sl=gfSlice(list('boundary',list('diff',list('cylinder', -1, [0;0;0], [0;1;0], r),list('cylinder', -1, [0;0;0], [0;1;0], r-4))),m, 6);
