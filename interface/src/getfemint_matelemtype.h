...
namespace getfemint
{
  id_type ind_matelemtype(getfem::pmat_elem_type);
  getfem::pmat_elem_type addr_matelemtype(id_type);
  bool exists_matelemtype(id_type);
  
}  /* end of namespace getfemint.                                          */

#endif /* GETFEMINT_MATELEMTYPE_H__                                        */
