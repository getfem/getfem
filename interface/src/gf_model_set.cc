...
build_sub_command_table(std::map<std::string, psub_command> &subc_tab) {
  ...
  sub_command
    ("add contact with rigid obstacle brick", 6, 9, 0, 1,
     THROW_ERROR("WARNING : gf_mesh_fem_get('add contact with rigid obstacle "
  ...
  sub_command
    ("add nonmatching meshes contact brick", 6, 13, 0, 1,
     THROW_ERROR("WARNING : gf_mesh_fem_get('add nonmatching meshes "
              << "contact brick', ...) is a deprecated command.\n"
              << "          Use gf_mesh_fem_get('add nodal contact between"
              << " nonmatching meshes brick', ...) instead.")
     );
  ...
  sub_command
    ("add rigid obstacle to large sliding contact brick", 3, 3, 0, 0,
     ...
     std::string expr = in.pop().to_string();
     size_type N = in.pop().to_integer();
     add_rigid_obstacle_to_large_sliding_contact_brick(*md, ind, expr, N);
     );
