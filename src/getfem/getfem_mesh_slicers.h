...
namespace getfem {
  ...
  */
  ...
  private:
    ...
    refined_simplex_mesh_for_convex_faces_cut_by_level_set(short_type f);
 
    void update_cv_data(size_type cv_, short_type f_ = short_type(-1));
    void init_indexes();
    void apply_slicers();
  };
