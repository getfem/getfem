...
// File    : gmm_sub_matrix.h : generic sub matrices.
//           
...
//   { return sub_matrix(m.M, si1, si2); }
  ...
  sub_matrix_toto(const mpi_distributed_matrix<MAT> &m, const SUBI1 &si1, const SUBI2 &si2)
  { return 10;/* sub_matrix(m.M, si1, si2); */ }
