...
namespace getfem {
  ...
  BDMk_::BDMk_(dim_type nc_, dim_type k_) {
    ...
    if (k > 1) {
      ...
      mesh m(*pm);
      mesh_fem mf(m);
      mf.set_classical_finite_element(pm->convex_index(), bgeot::dim_type(k-1));
      mesh_fem mfd(m);
      mfd.set_qdim(nc);
...
#     endif
  ...
  morley_element__::morley_element__(dim_type n) {
    ...
    if (n == 2) {
      ...
      std::stringstream s3
        ("5/3 - 16/9*x - 28/9*y - 28/9*z + 8/9*x^2 + 8/3*x*y + 8/3*x*z - 4/9*y^2 + 20/3*y*z - 4/9*z^2;"
         "5/3 - 28/9*x - 16/9*y - 28/9*z - 4/9*x^2 + 8/3*x*y + 20/3*x*z + 8/9*y^2 + 8/3*y*z - 4/9*z^2;"
         "5/3 - 28/9*x - 28/9*y - 16/9*z - 4/9*x^2 + 20/3*x*y + 8/3*x*z - 4/9*y^2 + 8/3*y*z + 8/9*z^2;"
         "-4/3 + 20/9*x + 20/9*y + 32/9*z + 8/9*x^2 - 4/3*x*y - 16/3*x*z + 8/9*y^2 - 16/3*y*z - 16/9*z^2;"
         "-4/3 + 20/9*x + 32/9*y + 20/9*z + 8/9*x^2 - 16/3*x*y - 4/3*x*z - 16/9*y^2 - 16/3*y*z + 8/9*z^2;"
         "-4/3 + 32/9*x + 20/9*y + 20/9*z - 16/9*x^2 - 16/3*x*y - 16/3*x*z + 8/9*y^2 - 4/3*y*z + 8/9*z^2;"
         "sqrt(3)*3/8 - sqrt(3)*x - sqrt(3)*y - sqrt(3)*z + sqrt(3)*1/2*x^2 + sqrt(3)*3/2*x*y + sqrt(3)*3/2*x*z + sqrt(3)*1/2*y^2 + sqrt(3)*3/2*y*z + sqrt(3)*1/2*z^2;"
         "-1/8 - 2/3*x + 1/3*y + 1/3*z + 11/6*x^2 - 1/2*x*y - 1/2*x*z - 1/6*y^2 - 1/2*y*z - 1/6*z^2;"
         "-1/8 + 1/3*x - 2/3*y + 1/3*z - 1/6*x^2 - 1/2*x*y - 1/2*x*z + 11/6*y^2 - 1/2*y*z - 1/6*z^2;"
         "-1/8 + 1/3*x + 1/3*y - 2/3*z - 1/6*x^2 - 1/2*x*y - 1/2*x*z - 1/6*y^2 - 1/2*y*z + 11/6*z^2;");
