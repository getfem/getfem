\documentclass[12pt,a4paper]{../doc}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=10cm,angle=0]{livret_intervention_pg.eps}
\end{center}
\end{figure}
\end{center}
 \newpage
...
\section{charte de documentation}
  Toutes les documentations sont \`a r\'ealiser en Anglais.
  \subsection{Documentation des sources C++}
  \`a compl\'eter
