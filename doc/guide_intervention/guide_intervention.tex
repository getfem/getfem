...
\section{charte de programmation}
 ...
 \subsection{Sources C++}
   ...
   \begin{itemize}
     ...
     \item pour toute modification, ou nouveau module, un programme de test est souhaitable. Ce programme doit tester les fonctionnalités des la librairie et est a mettre dans les répertoire test/ de la librairie concernée. Il faut rédiger un shell avec extension .dotest qui sera automatiquement exécuté.
   \end{itemize}
   \`a compl\'eter
