...
\section{Organigramme simplifi\'e de GETFEM}
GETFEM repr\'esente une sur-couche de GETFEM++ compos\'ee de sources C - C++ faisant interface \`a des commandes MATLAB et des sources MATLAB.
...
Les shells d'installation et de mise \`a jour regroupent toutes les instructions permettant de r\'ecup\'erer les sources, et d'installer un environnement de compilation et de test. Pour r\'ecup\'erer l'ensemble des shells d'installation, ex\'ecuter la commande
\begin{alltt}
