<?php $thisPage="Download"; include("header.inc") ?>
  <div id="content">
    ...
    <p>
      ...
      <ul>
<li>getfem++ library <a href="http://download.gna.org/getfem/stable/getfem++-3.0.tar.gz">getfem++-3.0.tar.gz</a> (includes gmm++, and the Matlab and Python interfaces)</li>
