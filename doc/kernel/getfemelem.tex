...
In the file {\tt bgeot\_poly\_integration.h} the following methods are defined
...
One can obtain a particular descriptor thanks to the function
{\tt bgeot::pintegration\_method pfe = bgeot::int\_method\_descriptor("name of method"); }\\[0.5cm]
...
int main(void) \{
  ...
  getfem::pmat_elem_computation pmec = // Object which computes elementary matrices.
     getfem::mat_elem(pet, bgeot::int\_method\_descriptor(method\_name),
