...
{\tt getfem::ppolyfem getfem::PK\_with\_cubic\_bubble\_fem(1, 1)} 
\end{tabular} \\ \vspace{-1pt} 
\begin{tabular}{|m{2cm}|m{2cm}|m{2.5cm}|m{1.5cm}|m{2cm}|m{2cm}|} \hline 
Degree & dimension & d.o.f. number & class & vectorial & \mbox{$\tau$-equivalent} \\ \hline
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{ \it Element which intepolates a finite element method defined on another mesh. The element has as many d.o.f. as the union of d.o.f. of triangles of the other mesh having an intersection with it. The interpolation is made on Gauss points of the integration method.} 
...
\begin{center}
\begin{tabular}{|m{14.18cm}|} \hline 
{ \bf Element which intepolates an element defined on another mesh}\\
