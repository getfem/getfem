...
\bar{\varphi}_{18}(x,y) = \sqrt{2}(-8x^2y^2 + 8x^3y^2 + 8x^2y^3), & (\partial_{x}\bar{\varphi}_0(1/2,1/2) + \partial_{y}\bar{\varphi}_{18}(1/2,1/2) = \sqrt{2}),\\
\bar{\varphi}_{19}(x,y) = -16xy^2 + 32x^2y^2 + 32xy^3 - 16x^3y^2 - 32x^2y^3 - 16xy^4, & (-\partial_{x}\bar{\varphi}_{19}(0,1/2) = 1),\\
\bar{\varphi}_{20}(x,y) = -16x^2y + 32x^3y + 32x^2y^2 - 16x^4y - 32x^3y^2 - 16x^2y^3, & (-\partial_{y}\bar{\varphi}_{20}(1/2,0) = 1),\\
\end{array}
$$
