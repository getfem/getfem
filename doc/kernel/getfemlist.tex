...
\subsubsection{Raviart-Thomas 0 element}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=10cm,angle=0]{getfemlist_RT0.eps}
  \end{center}
  \caption{ \it RT0 element in dimension two and three. (P+1 dof, H(div))} 
  \label{fig:triangle_comp}
\end{figure}
...
\subsubsection{Nedelec (or Whitney) edge element}
