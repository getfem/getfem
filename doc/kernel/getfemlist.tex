...
\begin{figure}[H]
  ...
  \end{center}
  \caption{ \it Hermite element on a triangle, $P_3$, 10 d.o.f., $C^0$ (``nearly'' $C^1$) }
...
\bar{\varphi}_{15}(x,y) = 0.5y^2 - 1.5y^3 - 1.5x^2y^2 + 1.5y^4 + x^3y^2 + 1.5x^2y^3 - 0.5y^5, & (\partial^2_{yy}\bar{\varphi}_{15}(0,0) = 1),\\
\bar{\varphi}_{16}(x,y) = 1.25x^2y^2 - 0.75x^3y^2 - 1.25x^2y^3, & (\partial^2_{yy}\bar{\varphi}_{16}(1,0) = 1),\\
\bar{\varphi}_{17}(x,y) = 0.5y^3 + 0.25x^2y^2 - y^4 - 0.25x^3y^2 - 0.25x^2y^3 + 0.5y^5, & (\partial^2_{yy}\bar{\varphi}_{17}(0,1) = 1),\\
\bar{\varphi}_{18}(x,y) = \sqrt{2}(-8x^2y^2 + 8x^3y^2 + 8x^2y^3), & \hspace*{-9.5em}(\sqrt{0.5}(\partial_{x}\bar{\varphi}_0(0.5,0.5) + \partial_{y}\bar{\varphi}_{18}(0.5,0.5)) = 1),\\
\bar{\varphi}_{19}(x,y) = -16xy^2 + 32x^2y^2 + 32xy^3 - 16x^3y^2 - 32x^2y^3 - 16xy^4, & (-\partial_{x}\bar{\varphi}_{19}(0,0.5) = 1),\\
\bar{\varphi}_{20}(x,y) = -16x^2y + 32x^3y + 32x^2y^2 - 16x^4y - 32x^3y^2 - 16x^2y^3, & (-\partial_{y}\bar{\varphi}_{20}(0.5,0) = 1),\\
\end{array}
$$
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{ \it Hermite element on a tetrahedron, $P_3$, 20 d.o.f., $C^0$ (``nearly'' $C^1$)}
...
$$
  \begin{array}{ll}
\bar{\varphi}_{0}(x,y) = 1 - 3x^2 - 13xy - 13xz - 3y^2 - 13yz - 3z^2 + 2x^3 + 13x^2y + 13x^2z & \\
 ~~~~~~~~~~~~~~~ + 13xy^2 + 33xyz + 13xz^2 + 2y^3 + 13y^2z + 13yz^2 + 2z^3, & (\bar{\varphi}_0(0,0,0) = 1),\\
\bar{\varphi}_{1}(x,y) = 3x^2 - 7xy - 7xz - 2x^3 + 7x^2y + 7x^2z + 7xy^2 + 7xyz + 7xz^2, & (\bar{\varphi}_0(1,0,0) = 1),\\
\bar{\varphi}_{2}(x,y) = -7xy + 3y^2 - 7yz + 7x^2y + 7xy^2 + 7xyz - 2y^3 + 7y^2z + 7yz^2, & (\bar{\varphi}_0(0,1,0) = 1),\\
\bar{\varphi}_{3}(x,y) = -7xz - 7yz + 3z^2 + 7x^2z + 7xyz + 7xz^2 + 7y^2z + 7yz^2 - 2z^3, & (\bar{\varphi}_0(0,0,1) = 1),\\
\bar{\varphi}_{4}(x,y) = 27xyz, & (\bar{\varphi}_0(1/3,1/3,1/3) = 1),\\
\bar{\varphi}_{5}(x,y) = 27yz - 27xyz - 27y^2z - 27yz^2, & (\bar{\varphi}_0(0,1/3,1/3) = 1),\\
\bar{\varphi}_{6}(x,y) = 27xz - 27x^2z - 27xyz - 27xz^2, & (\bar{\varphi}_0(1/3,0,1/3) = 1),\\
\bar{\varphi}_{7}(x,y) = 27xy - 27x^2y - 27xy^2 - 27xyz, & (\bar{\varphi}_0(1/3,1/3,0) = 1),\\
\bar{\varphi}_{8}(x,y) = x - 2x^2 - 3xy - 3xz + x^3 + 3x^2y + 3x^2z + 2xy^2 + 4xyz + 2xz^2, & (\bar{\partial_x\varphi}_0(0,0,0) = 1),\\
\bar{\varphi}_{9}(x,y) = -x^2 + 2xy + 2xz + x^3 - 2x^2y - 2x^2z - 2xy^2 - 2xyz - 2xz^2, & (\bar{\partial_x\varphi}_0(1,0,0) = 1),\\
\bar{\varphi}_{10}(x,y) = -xy + x^2y + 2xy^2, & (\bar{\partial_x\varphi}_0(0,1,0) = 1),\\
\bar{\varphi}_{11}(x,y) = -xz + x^2z + 2xz^2, & (\bar{\partial_x\varphi}_0(0,0,1) = 1),\\
\bar{\varphi}_{12}(x,y) = y - 3xy - 2y^2 - 3yz + 2x^2y + 3xy^2 + 4xyz + y^3 + 3y^2z + 2yz^2, & (\bar{\partial_y\varphi}_0(0,0,0) = 1),\\
\bar{\varphi}_{13}(x,y) = -xy + 2x^2y + xy^2, & (\bar{\partial_y\varphi}_0(1,0,0) = 1),\\
\bar{\varphi}_{14}(x,y) = 2xy - y^2 + 2yz - 2x^2y - 2xy^2 - 2xyz + y^3 - 2y^2z - 2yz^2, & (\bar{\partial_y\varphi}_0(0,1,0) = 1),\\
\bar{\varphi}_{15}(x,y) = -yz + y^2z + 2yz^2, & (\bar{\partial_y\varphi}_0(0,0,1) = 1),\\
\bar{\varphi}_{16}(x,y) = z - 3xz - 3yz - 2z^2 + 2x^2z + 4xyz + 3xz^2 + 2y^2z + 3yz^2 + z^3, & (\bar{\partial_z\varphi}_0(0,0,0) = 1),\\
\bar{\varphi}_{17}(x,y) = -xz + 2x^2z + xz^2, & (\bar{\partial_z\varphi}_0(1,0,0) = 1),\\
\bar{\varphi}_{18}(x,y) = -yz + 2y^2z + yz^2, & (\bar{\partial_z\varphi}_0(0,1,0) = 1),\\
\bar{\varphi}_{19}(x,y) = 2xz + 2yz - z^2 - 2x^2z - 2xyz - 2xz^2 - 2y^2z - 2yz^2 + z^3, & (\bar{\partial_z\varphi}_0(0,0,1) = 1),\\
  \end{array}
$$
This element is not \mbox{$\tau$-equivalent} (The matrix $\tilde{M}$ is not equal to identity). On the real element linear combinaisons of $\bar{\varphi}_8$, $\bar{\varphi}_{12}$ and $\bar{\varphi}_{16}$ are used to match the gradient on the corresponding vertex. Idem on the orther vertices. 
