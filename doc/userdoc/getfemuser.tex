...
\begin{ctableau}{|m{0.4\linewidth}|m{0.55\linewidth}|}{ll}\hline
  ...
  \cpp{mesh.convex_quality_estimate(ic) & gives an rought estimate of the quality of element \cpp{ic}. \\ \hline

  \cpp{mesh.convex_radius_estimate(ic) & gives an estimate of the radius of element \cpp{ic}. \\ \hline
