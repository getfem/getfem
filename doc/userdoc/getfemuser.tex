...
\cpp{add\_initialized\_fixed\_size\_data(name, V, niter=1)} & Add a data of fixed size initialized with the given vector \cpp{V}. \cpp{name} is a string which designate the data. \cpp{niter} is the number of copy of the data (used for time integration schemes). \\ \hline
...
See the section on time integration scheme to see how to use this brick to build an approximation of a transient problem.
