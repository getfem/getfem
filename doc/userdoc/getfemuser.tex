...
\begin{alltt}
  getfem::mdbrick_scalar_elliptic<MODEL_STATE> brick(mim, mf_u, mf_data, k, mat_stored);
\end{alltt}
...
\begin{alltt}
  getfem::mdbrick_scalar_elliptic<MODEL_STATE> brick(mim, mf_u, mf_data, k, laplace, mat_stored);
\end{alltt}
...
\begin{alltt}
  getfem::mdbrick_isotropic_linearized_elasticity<MODEL_STATE>
     brick(mim, mf_u, mf_data, lambda, mu, mat_stored);
\end{alltt}
...
\begin{alltt}
  getfem::mdbrick_isotropic_linearized_elasticity(mim, mf_u, mf_data, lambda, mu, mat_stored);
\end{alltt}
...
The constructor is
\begin{alltt}
  getfem::mdbrick_Helmholtz<MODEL_STATE> brick(mim, mf_u, mf_data, k, mat_stored);
\end{alltt}
