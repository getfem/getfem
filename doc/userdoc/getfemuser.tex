...
\cpp{getfem::interpolated\_fem(getfem::mesh\_fem mf, getfem::mesh\_um mim) }\\[0.2cm]
...
\begin{cppcode}
  ...
  getfem::interpolated\_fem feminterpolated(mf2, mim);
  dal::bit\_vector nn = mf1.convex\_index();
  mf\_interpole.set\_finite\_element(nn, &feminterpolated);
