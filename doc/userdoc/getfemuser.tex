...
Using that constructor, you can build the problem like with any other bricks, adding the Volumic, Neumann and Dirichlet bricks as usual (look at elastostatic.C and plasticity.C for exemples), and call the solver with \cpp{getfem::standard_solve(MS, final_model, iter);}.
