...
A non exhautive list (see \cite{FEM_LIST} for exhaustive lists) of finite element methods is given by
...
{\tt mef.set\_finite\_element(i, getfem::fem\_descriptor("FEM\_PK(2, 1)"),\\$\mbox{}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ $  bgeot::int\_method\_descriptor("IM\_EXACT\_SIMPLEX(2)")); }\\[0.5cm]
...
{\tt mef.set\_finite\_element(mesh.convex\_index(), getfem::fem\_descriptor("FEM\_PK(2, 1)"),\\$\mbox{}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ $ bgeot::int\_method\_descriptor("IM\_EXACT\_SIMPLEX(2)")); }\\[0.5cm]
