...
\index{GMM! gmm::iteration}
  The iteration object of GMM is a modification of the one in ITL. This is not a template type as in ITL. Preconditionners has not ben yet implemented in GMM, so for the moment it is only possible to use precondionners represented by a matrix. 
