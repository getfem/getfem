...
.. csv-table::
   ...
   :file:`getfem_im_data.h` and :file:`getfem_im_data.cc`, "Define an object representing a scalar, a vector or a tensor on each Gauss point of a mesh_im object. Used for instance in plasticity approximation. Interpolation of arbitrary expressions can be made thanks to the high-level generic assembly language."
