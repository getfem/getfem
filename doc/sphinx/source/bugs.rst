...
Bug reports should be submitted via the GNA Bug Tracker
(https://gna.org/task/?group=getfem).  The bug tracker offers a Web form which
allows pertinent information to be entered and submitted to the developers.
