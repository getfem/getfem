...
should be able to use the python interface without any particular knowledge of
the getfem internals, although a basic knowledge about Finite Elements is
required.
